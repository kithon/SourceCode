...
class DecisionTree(object):
    # slots
    __slots__ = ['radius', 'num_function', 'condition', 'np_rng', 'picture', 'generate_threshold', 'tree_list']
...
class Node(object):
    # slots
    __slots__ = ['data', 'picture', 'depth', 'condition', 'terminal', 'label', 'function', 'r_index', 'l_index']
...
class ExtremeDecisionTree(DecisionTree):
    # slots
    __slots__ = ['radius', 'num_function', 'condition', 'np_rng', 'picture', 'generate_threshold', 'tree_list', 'elm_hidden', 'elm_coef', 'visualize']
